...
export default function Cmt({ isOpen, Close }) {
  if (!isOpen) return null;
  return (
    <div className="w-full py-24 overflow-y-auto fixed z-[9999] inset-0 bg-black bg-opacity-50 flex justify-between items-center z-50">
      
      <div className="w-full max-w-7xl px-4 relative mt-auto md:px-5 lg:px-5 mx-auto">
      <FaTimes className="w-10 h-10 text-red-600 absolute top-0 right-9 hover:text-blue-600 cursor-pointer" onClick={Close} />
                ...
                <div className="w-full lg:pl-60 md:pl-20 sm:pl-10 pl-7 flex-col justify-start items-end gap-2.5 flex">
                  <div className="w-full p-6 bg-gray-50 rounded-2xl border border-gray-200 flex-col justify-start items-start gap-8 flex">
                    <div className="w-full flex-col justify-center items-start gap-3.5 flex">
                      ...
                      <p className="text-gray-800 text-sm font-normal leading-snug">
                        Absolutely! I was amazed at how much they grew throughout
                        the story. The way the author portrayed their struggles and
                        triumphs was truly inspiring.
                      </p>
                    </div>
                    <div className="w-full justify-between items-center inline-flex">
                      <div className="justify-start items-center gap-4 flex">
              ...
              <div className="w-full flex-col justify-start items-end gap-5 flex">
                <div className="w-full p-6 bg-white rounded-2xl border border-gray-200 flex-col justify-start items-start gap-8 flex">
                  <div className="w-full flex-col justify-center items-start gap-3.5 flex">
                    ...
                    <p className="text-gray-800 text-sm font-normal leading-snug">
                      The themes in this book really made me think about life and
                      purpose. It's a very introspective read that encourages
                      self-reflection and personal growth. The way the author weaves
                      philosophical questions into the storyline is seamless and
                      thought-provoking. Each chapter seemed to pose new questions
                      about identity, morality, and the human condition. It’s one of
                      those books that stays with you long after you’ve turned the
                      last page, prompting you to reflect on your own beliefs and
                      values. The narrative was both compelling and enlightening,
                      providing a deep dive into the complexities of life.
                    </p>
                  </div>
                  <div className="w-full justify-between items-center inline-flex">
                    <div className="justify-start items-center gap-4 flex">
                  ...
                  <div className="w-full p-6 bg-gray-50 rounded-2xl border border-gray-200 flex-col justify-start items-start gap-8 flex">
                    <div className="w-full flex-col justify-center items-start gap-3.5 flex">
                      ...
                      <p className="text-gray-800 text-sm font-normal leading-snug">
                        ...
                        impact on my thoughts and perspectives. The narrative was
                        both compelling and enlightening, truly a thought-provoking
                        read. I found myself pondering the themes long after I’d
                        finished the book, which is a testament to the author’s
                        skill in crafting such a reflective and meaningful story.
                        It’s the kind of book that sparks deep conversations and
